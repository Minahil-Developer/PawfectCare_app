...
import 'health_tracking.dart';
import 'appointments.dart';
import 'pet_store.dart';
import 'blog_tips.dart';
        ...
        child: Column(
          ...
          children: [
            if (_isLoading)
              ...
              Center(
                child: Text(
                  'Welcome ${_userData?['name'] ?? 'to Pawfect Care'}!',
            ...
            Center(
              child: const Text(
                'Manage all your pet care needs in one place',
                ...
                _buildFeatureCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const PetStorePage(),
                      ),
                    );
                  },
                ),
                _buildFeatureCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const BlogTipsPage(),
                      ),
                    );
                  },
                ),
